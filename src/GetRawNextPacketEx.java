...
public class GetRawNextPacketEx {
    ...
    private static final String PCAP_FILE = System.getProperty(PCAP_FILE_KEY, ".\\file\\testbed-13jun.pcap");
...
*/
        ...
        Timestamp timestampI = new Timestamp(0);
        Timestamp timestampF = new Timestamp(0);
        while (true) {
            PcapPacket packet = handle.getNextPacket();


            numPct += 1;
            System.out.println("Pacote: " + numPct);
            //Se não houver mais pacotes sai do loop
            if (packet == null) {
                System.out.println("Número total de pacotes: " + numPct);
                break;
            }
            ...
            if (eHeader.getType().valueAsString().equals("0x0800")) {
                ...
                System.out.println("Src Address: " + ipV4Header.getSrcAddr());
                System.out.println("Dst Address: " + ipV4Header.getDstAddr());
                System.out.println("Tamanho Total: " + packet.getPacket().length());
                ...
                if (ipV4Header.getProtocol().valueAsString().equals("17")) {
                    ...
                    System.out.println("Source Port (16 bits): " + ((headerUdp != null) ? headerUdp.getSrcPort() : 0));
                    System.out.println("Destination Port (16 bits): " + ((headerUdp != null) ? headerUdp.getDstPort():0));
                    System.out.println("Length (16 bits): " + ((headerUdp != null) ? headerUdp.getLengthAsInt():0));
                    System.out.println("Checksum (16 bits): " + ((headerUdp != null) ?headerUdp.getChecksum():0));
                    System.out.println();
                }
